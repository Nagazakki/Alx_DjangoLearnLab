...
class AuthorSerializer(serializers.ModelSerializer):
    ...
    Performance Considerations:
        The nested serialization can cause N+1 query problems. In production,
        consider using select_related() or prefetch_related() in the view
        to optimize database queries.
    """
    
    # Nested serialization: Include full details of all books by this author
    ...
    def to_representation(self, instance):
        """
        Override the default representation to add additional context.
        
        This method demonstrates how to customize the serialized output
        beyond the default field serialization.
        
        Args:
            instance (Author): The Author model instance being serialized
            
        Returns:
            dict: The serialized representation with custom formatting
        """
